...
function createXscaleObj(inputData: Yscale_InputObj[]): XscaleObj {
  let data: ScaleY_itemObject[] = inputData.map(item => ({
    id: item.id,
...
// Example usage:
const inputData: Yscale_InputObj[] = [

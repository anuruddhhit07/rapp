import { Shared_PlotInfo, generateRelationObject, getPlotNamesAndYScaleTagsByYAxisTag, getPlotStatusByButtonTag, getUniquePlotsWithStatusTrue, getYaxisRatio, updateSharedChartData, updateXscaleconfig, updateYScaleConfigByKey, updateYaxis, updateYscaleconfig, updateplotInfo, } from "./SharedDataUtility";
export function InitializeBaseProp() {
    updateXscaleconfig();
    updateYscaleconfig();
    updateplotInfo();
    const uniquePlotsData = getUniquePlotsWithStatusTrue(Shared_PlotInfo);
